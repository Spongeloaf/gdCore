...
// TODO: See if this can be made generic, so that users can can provide the enums and
...
public static class Log
{
    ...
    public static void Debug(DebugCategory cat, string message, params object[] formatValues)
    {
        ...
        string fmtMessage = string.Format(message, formatValues);
        GD.Print(fmtMessage);
        System.Diagnostics.Debug.WriteLine(fmtMessage);
